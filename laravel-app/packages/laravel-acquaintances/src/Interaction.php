...
class Interaction
{
    ...
    {
        return array_merge(self::$relationMap, config('acquaintances.interactions.relation_map', []));
    }
...
//            'created_at' => Carbon::now(),
    ...
    {
        if ( ! \array_key_exists($relation->getRelationName(), self::getRelationMap())) {
            throw new \Exception('Invalid relation definition.');
        }

        return self::getRelationMap()[$relation->getRelationName()];
    }
